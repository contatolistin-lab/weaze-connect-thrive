...
import { Home, MessageSquare, Users, Plus, BarChart3, User, LifeBuoy } from "lucide-react";
...
const baseItems: Item[] = [
  ...
  { to: "/atendimento", icon: LifeBuoy, label: "Atendimento" },
];
...
export function DesktopSidebar() {
  ...
  const items: Item[] = [
    ...baseItems.filter(
      (it) =>
        (it.to !== "/create" && it.to !== "/metricas" && it.to !== "/atendimento") || showB2BOnly,
    ),
