      ...
      <div className="mx-auto max-w-md min-h-dvh bg-surface-muted pb-8">
        ...
        <header className="bg-brand-gradient text-white px-5 pt-5 pb-8 rounded-b-3xl shadow-brand">
          ...
          <div className="mt-5 flex items-center gap-3">
            <span className="h-14 w-14 rounded-2xl bg-white text-[#8800aa] grid place-items-center font-extrabold text-2xl">
              N
            </span>
            <div>
        ...
        <section className="px-4 mt-5">
          ...
          <div className="mt-3 grid grid-cols-2 gap-3">
            {[
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="h-9 w-9 rounded-xl bg-brand-gradient-soft text-[#8800aa] grid place-items-center">
                    <k.icon size={18} />
                  </span>
        ...
        <section className="px-4 mt-5">
          <div className="rounded-3xl bg-white border border-border p-5 shadow-soft">
            <div className="flex items-center justify-between">
              ...
              <BarChart3 size={20} className="text-[#8800aa]" />
            </div>
