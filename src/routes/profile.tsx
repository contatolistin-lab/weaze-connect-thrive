  ...
  return (
    <div>
      ...
      <input
        ...
        className="w-full h-10 rounded-xl border border-border px-3 text-sm outline-none focus:ring-2 focus:ring-[#630091] bg-white"
      />
    </div>
  );
}
  ...
  return (
    <div>
      ...
      <textarea
        ...
        onChange={(e) => onChange(e.target.value)}
        rows={3}
        className="w-full rounded-xl border border-border p-3 text-sm outline-none focus:ring-2 focus:ring-[#630091] resize-none bg-white"
      />
    </div>
  );
}
